...
public class RecycleViewRefresh  extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public RecycleViewRefresh(Context context, AttributeSet attrs, int defStyleAttr) {
