...
public class mSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    mSwipeRefreshLayout.OnRefreshListener mListener;
    ...
    private mSwipeRefreshLayout.OnChildScrollUpCallback mChildScrollUpCallback;
    ...
    /**
     * Simple constructor to use when creating a mSwipeRefreshLayout from code.
     *
     * @param context
     */
    ...
    /**
     * Constructor that is called when inflating mSwipeRefreshLayout from XML.
     *
     * @param context
     * @param attrs
     */
    ...
    private void createProgressView() {
        mCircleView = new mCircleImageView(getContext(), CIRCLE_BG_LIGHT);
     ...
     * gesture.
     */
    public void setOnRefreshListener(mSwipeRefreshLayout.OnRefreshListener listener) {
        mListener = listener;
    }
    ...
    /**
     * Set a callback to override {@link mSwipeRefreshLayout#canChildScrollUp()} method. Non-null
     * callback will return the value provided by the callback and ignore all internal logic.
     *
     * @param callback Callback that should be called when canChildScrollUp() is called.
     */
    public void setOnChildScrollUpCallback(@Nullable mSwipeRefreshLayout.OnChildScrollUpCallback callback) {
 ...
 /*       if (yDiff > mTouchSlop && !mIsBeingDragged) {
    ...
    /**
     * Classes that wish to override {@link mSwipeRefreshLayout#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link mSwipeRefreshLayout#canChildScrollUp()} method
         * is called to allow the implementer to override its behavior.
         *
         * @param parent mSwipeRefreshLayout that this callback is overriding.
         * @param child  The child view of mSwipeRefreshLayout.
         * @return Whether it is possible for the child view of parent layout to scroll up.
         */
        boolean canChildScrollUp(mSwipeRefreshLayout parent, @Nullable View child);
    }
}
