 ...
 */
public class SlidingLayoutView extends FrameLayout {
    // 页面边缘阴影的宽度默认值
    ...
    public SlidingLayoutView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context) {
        ...
        mLeftShadow = getResources().getDrawable(R.drawable.act_shadow);
